...
[save_network]
output_dir = outputs/02_PMJ_Linktries:10/LV_seed:%d
...
[save_network]
output_dir = outputs/02_PMJ_Linktries:10/RV_back_top_seed:%d
...
[save_network]
output_dir = outputs/02_PMJ_Linktries:10/RV_back_bottom_seed:%d
...
[save_network]
output_dir = outputs/02_PMJ_Linktries:10/RV_front_top_seed:%d
...
[save_network]
output_dir = outputs/02_PMJ_Linktries:10/RV_front_bottom_seed:%d
