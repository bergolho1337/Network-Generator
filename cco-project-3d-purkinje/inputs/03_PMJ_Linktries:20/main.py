...
[save_network]
output_dir = outputs/03_PMJ_Linktries:20/LV_seed:%d
...
[save_network]
output_dir = outputs/03_PMJ_Linktries:20/RV_back_top_seed:%d
...
[save_network]
output_dir = outputs/03_PMJ_Linktries:20/RV_back_bottom_seed:%d
...
[save_network]
output_dir = outputs/03_PMJ_Linktries:20/RV_front_top_seed:%d
...
[save_network]
output_dir = outputs/03_PMJ_Linktries:20/RV_front_bottom_seed:%d
