...
[save_network]
output_dir = outputs/04_Elizabeth/04_CO_Activation_Time_Terminals/RV_seed:%d
...
[save_network]
output_dir = outputs/04_Elizabeth/04_CO_Activation_Time_Terminals/LV_seed:%d
