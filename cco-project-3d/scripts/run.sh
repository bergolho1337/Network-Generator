...
for SEED in "${SEEDS[@]}"; do
	...
	#python mean_std.py /home/berg/Github/Network-Generator/cco-project-3d/outputs/04_Elizabeth/01_CO_Length/seed:${SEED}/segments_length.dat
	#python mean_std.py /home/berg/Github/Network-Generator/cco-project-3d/outputs/04_Elizabeth/01_CO_Length/seed:${SEED}/bifurcations_angle.dat
	#python mean_std.py /home/berg/Github/Network-Generator/cco-project-3d/outputs/04_Elizabeth/02_CO_Activation_Time/seed:${SEED}/segments_length.dat
	python mean_std.py /home/berg/Github/Network-Generator/cco-project-3d/outputs/04_Elizabeth/02_CO_Activation_Time/seed:${SEED}/bifurcations_angle.dat
done
