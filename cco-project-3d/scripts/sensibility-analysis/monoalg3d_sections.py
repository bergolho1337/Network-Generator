...
def write_monoalg_save_result_section (file,seed,rand_offset,algorithm_number,use_cluster=False):
    ...
    #file.write("output_dir = ./outputs/elizabeth_co:min_length_with_pruning_seed:%u\n" % (seed))
    file.write("output_dir = ./outputs/elizabeth_co:min_at_with_pruning_seed:%u\n" % (seed))
...
def write_monoalg_purkinje_section (file,seed,rand_offset,algorithm_number,use_cluster=False):
    ...
    #file.write("network_file=networks/03_Lucas/01_SRN/05_CO_Length_With_Pruning/seed:%u.vtk\n" % (seed))
    file.write("network_file=networks/03_Lucas/01_SRN/06_CO_Activation_Time_With_Pruning/seed:%u.vtk\n" % (seed))
...
def write_monoalg_config_file (seed,rand_offset,algorithm_number):
    ...
    #filename = "monoalg3d/co_min:length_with_pruning_seed-%u_nterm:650.ini" % (seed)
    filename = "monoalg3d/co_min:at_with_pruning_seed-%u_nterm:650.ini" % (seed)
