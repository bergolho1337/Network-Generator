...
int parse_config_file(void *user, const char *section, const char *name, const char *value) 
{
    ...
    if (SECTION_STARTS_WITH(MAIN_SECTION))
    {
        ...
        else if (MATCH_NAME("I_in"))
        {
            pconfig->I_in = strtof(value, NULL);
        }
        else if (MATCH_NAME("V_in"))
        {
            pconfig->V_in = strtof(value, NULL);
        }
        else if (MATCH_NAME("V_out"))
        {
            pconfig->V_out = strtof(value, NULL);
        }
        else if (MATCH_NAME("r_perf"))
        {
            pconfig->r_perf = strtof(value, NULL);
        }
    }
