...
{
  printf("%s\n",PRINT_LINE);
  printf("Usage:> %s <input_STL_filename> <input_VTK_filename> <output_STL_filename>\n",pname);
  printf("%s\n",PRINT_LINE);
  printf("<input_STL_filename> = Input mesh in STL format\n");
  printf("<input_VTK_filename> = Input network in VTK format\n");
  printf("<output_STL_filename> = Output mesh in STL format\n");
  printf("%s\n",PRINT_LINE);
}